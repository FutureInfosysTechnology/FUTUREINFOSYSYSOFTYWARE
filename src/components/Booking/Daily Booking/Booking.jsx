...
function Booking({ selectedDocket, setSelectedDocket }) {
    ...
    const handlePinvoiceDetailChange = (e) => {
        const { name, value } = e.target;
    ...
    const handlePinvoiceAddRow = (e) => {
        ...
        if (editIndex !== null && PinvoicesubmittedData[editIndex]) {
            // Update existing row
            const oldInvoice = [...PinvoicesubmittedData];
            oldInvoice[editIndex] = PinvoiceData;
            setPinvoiceSubmittedData(oldInvoice);
            setEditIndex(null); // reset edit mode
    ...
    useEffect(() => {
        const qty = parseFloat(PinvoiceData.Qty) || 0;
        const rate = parseFloat(PinvoiceData.UnitRate) || 0;
        ...
        <>
            ...
            <div className="body" style={{ margin: "0px", padding: "0px" }}>
                ...
                <div className="container1" style={{ padding: "0px", margin: "0px", paddingBottom: "0.8rem" }}>
                    ...
                    <Modal overlayClassName="custom-overlay" isOpen={modalIsOpen11}
                        style={{
                            content: {
                                width: '90%',
                                top: '50%',             // Center vertically
                        ...
                        <div className="custom-modal-content">
                            <div className="header-tittle">
                                <header>Performa Invoice Details</header>
                            </div>
                            <div className='container2'>
                                <div className="table-container" style={{ paddingLeft: "10px", paddingRight: "10px" }}>
                                    <table className="table table-bordered table-sm">
                                        ...
                                        <tbody className="table-body">
                                            ...
                                            {/* SUBMITTED ROWS */}
                                            {PinvoicesubmittedData.map((data, index) => (
                                                <tr key={index}>
                                ...
                                <form action="" style={{ backgroundColor: "white", justifyContent: "center" }}>
                                    <div className="fields2">
                                        ...
                                        <div className="input-field1">
                                            <label htmlFor="">Total Invoice Value</label>
                                            <input type="text" placeholder="Total Invoice Value" value={totalInvoiceValue} readOnly />
                                        </div>
                                    </div>
                                </form>
                                <div className="bottom-buttons">
                                    <button className="ok-btn" onClick={() => setModalIsOpen11(false)}>Submit</button>
                                    <button className="ok-btn" onClick={() => setModalIsOpen11(false)}>Cancel</button>
                                </div>
                            </div>
